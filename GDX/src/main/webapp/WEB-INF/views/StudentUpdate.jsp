...
<nav class="navbar navbar-default" role="navigation" style="background: black">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand " href="../Student/Main?sno=${sno}" style="color: white">学生成绩管理系统 -- 学生</a>
        </div>
        <ul class="nav navbar-nav navbar-right">
            <li><a href="../Student/Main?sno=${sno}"><span class="glyphicon glyphicon-user" style="color: white"></span>返回&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
        </ul>
    </div>
</nav>
<div class="container">
    <div class="row">
        <div class="Box">
            <h2>修改密码</h2>
            <form action="../Student/updatepass">
                <div class="InputBox">
